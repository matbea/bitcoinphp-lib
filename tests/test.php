...
try {
    ...
    //$res = $bridge->listunspent("1GCG9wBFonTWE1rA61AcN54poZ3AUVT4jc",1);
    //$res = $bridge->getbalance("1CwWoKZhAssFP5zFPz6KL97auwr5bS5sCa", 0);
    //$res = $bridge->getunconfirmedbalance("1CwWoKZhAssFP5zFPz6KL97auwr5bS5sCa");

    //$o = new \BTCBridge\Api\ListTransactionsOptions();
    //$o->setLimit(1);
    //$o->setStarttxid("5c838a768bc339f12fe59786850f87410281559f6209512756df04b776f1d814");
    //$o->setOmitAddresses(false);
    //$o->setConfirmations(11000);
    //$lt = $bridge->listtransactions('12S_1MN', $o);
    $w = new \BTCBridge\Api\Wallet();
    //$w->setSystemDataByHandler($matbeaHandler->getHandlerName(), ["name" => "12S_1MN","id" => 462]);
    $w->setSystemDataByHandler($matbeaHandler->getHandlerName(), ["name" => "tst","id" => 856]);
    //$wallet = $bridge->removeAddresses("tst");
    //$bridge->deleteWallet("tst");
    $o = new \BTCBridge\Api\WalletActionOptions();
    $o->setOmitAddresses(true);
    //$wallet = $bridge->createWallet("tst", ['111111111111111111112xT3273'], $o);
    /*$wallet = $bridge->createWallet(
        "tst1",
        ['n1a44regv5cocoqDgEBtCvf8P6SjDqKyFP','n3GNqMveyvaPvUbH469vDRadqpJMPc84JA'],
        $o
    );*/
    /*$wallet = $bridge->addAddresses(
        $w,
        ['12S42ZEw2741DHrivgZHLfX8M58mxb7bFy', '1MN3cT9Ro927h4kgpSZ5V7SfYjrwTysXv7'],
        $o
    );*/
    //$wallet = $bridge->getAddresses($w);
    //$wallet = $bridge->removeAddresses($w, ['1MN3cT9Ro927h4kgpSZ5V7SfYjrwTysXv7', '12S42ZEw2741DHrivgZHLfX8M58mxb7bFy'], $o);
    //$w->setSystemDataByHandler($matbeaHandler->getHandlerName(), ["name" => "tst","id" => 858]);
    //$bridge->deleteWallet($w);
    //$bridge->getWallets($o);
    //$res = $bridge->listtransactions("12S42ZEw2741DHrivgZHLfX8M58mxb7bFy");
    //$res = $bridge->listunspent("12S42ZEw2741DHrivgZHLfX8M58mxb7bFy");
    //$wallet = $bridge->createWallet("tst", ['111111111111111111112xT3273']);
    //$w = new \BTCBridge\Api\Wallet();
    //$w->setSystemDataByHandler($matbeaHandler->getHandlerName(), ["name" => "tst","id" => 860]);
    //$w = $bridge->addAddresses($w, ['12S42ZEw2741DHrivgZHLfX8M58mxb7bFy', '1MN3cT9Ro927h4kgpSZ5V7SfYjrwTysXv7']);
    //$w = $bridge->removeAddresses($w, ['1MN3cT9Ro927h4kgpSZ5V7SfYjrwTysXv7']);
    //$w = $bridge->getAddresses($w);
    //$w = $bridge->getWallets();
    //$bridge->deleteWallet($w);
    //die;

    //$addresses = $bridge->getAddresses($w);
    //$o = new \BTCBridge\Api\GetWalletsOptions();
    //$o->setNoaddresses(true);
    //$bridge->getWallets($o);
    /*$wallet = $bridge->getAddresses($w);
    $wallet = $bridge->addAddresses($w,['111111111111111111112xT3273']);
    $wallet = $bridge->getAddresses($w);
    $wallet = $bridge->removeAddresses($w,['111111111111111111112xT3273']);*/
    //$bridge->deleteWallet($w);
    //$bridge->createWallet("tst19", ['2MyEuAns65FtS5WhBqPDnA6j2CnRWLuvpus']);
    //die;

    /*$w  = new \BTCBridge\Api\Wallet();
    $w->setName("12S42ZEw2741DHrivgZHLfX8M58mxb7bFy"); //$w->setName("system_matbea_wallet");
    $w->setName("1Am8uVz6rG7gJD9wvPHtXiuf5L6MVA1ALz");
    $res = $bridge->getbalance($w->getName());
    $res = $bridge->getunconfirmedbalance($w->getName());*/

    //$w->setSystemDataByHandler($matbeaHandler->getHandlerName(),["name" => "system_matbea_wallet","id" => 825]);
    //$w->setSystemDataByHandler($matbeaHandler->getHandlerName(),["name" => "tst18","id" => 813]);
    //$bridge->removeAddresses($w,['175N3Et8n1epm5YkYgn77GDdVAemekvXkk','1NgWtSrgmixp73ZKucKXyNZg3m9PSyEMkF']);
    //$wallet = $bridge->addAddresses($w,['175N3Et8n1epm5YkYgn77GDdVAemekvXkk_']);
    //$wallet = $bridge->addAddresses($w,['1QE6eCHEbVYqgbaBX3pYmjp6aWHQgFDW6V','175N3Et8n1epm5YkYgn77GDdVAemekvXkk','1NgWtSrgmixp73ZKucKXyNZg3m9PSyEMkF']);
    //$wallet = $bridge->addAddresses($w,[]);

    //$wallet = $bridge->createWallet("tst19",['175N3Et8n1epm5YkYgn77GDdVAemekvXkk','1QE6eCHEbVYqgbaBX3pYmjp6aWHQgFDW6V']);
    //$wallet = $bridge->createWallet("tst19",['1QE6eCHEbVYqgbaBX3pYmjp6aWHQgFDW6V','175N3Et8n1epm5YkYgn77GDdVAemekvXkk_']);
    ...
    //$o->setLimit(1000);
    //$o->setOffset(null);
    //$lt = $bridge->listtransactions('169yZX4ax7RRQehfkVDUZfMu9xyPpBURXA',$o);
    ...
    */
    ...
    fwrite(STDERR, $ex->getMessage() . PHP_EOL);
    exit(1);
} catch (\BTCBridge\Exception\BridgeException $ex) {
    fwrite(STDERR, $ex->getMessage() . PHP_EOL);
    exit(1);
} catch (\Exception $ex) {
    fwrite(STDERR, $ex->getMessage() . PHP_EOL);
